...
const darkSubHeader = TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500);

const lightHeader1 = TextStyle(fontSize: 35, fontWeight: FontWeight.w900, color: Colors.white);
